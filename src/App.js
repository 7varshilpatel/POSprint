...
function App() {
  ...
  const [textToPrint, setTextToPrint] = useState(`            POSprint STORE
========================================
...
========================================
               ITEMS
----------------------------------------
Item A (General Product) x2     15.00
Item B (Standard Goods) x1     25.00
Item C (Retail Product)  x3      8.00
----------------------------------------
Subtotal:                        80.00
Discount:                         0.00
Tax:                           500.00
...
========================================
    Thank you for visiting POSprint!`);
  ...
  const manualDetectAgent = useCallback(async () => {
    addLog('Manually detecting POSprint Agent...', 'info');
  ...
  const downloadAgent = () => {
    ...
    if (userAgent.includes('win') || platform.includes('win')) {
      downloadUrl = `${ENV_CONFIG.agentDownloadUrl}/download/POSprint-Agent-Windows.exe`;
      detectedOS = 'Windows';
    } else if (userAgent.includes('mac') || platform.includes('mac')) {
      downloadUrl = `${ENV_CONFIG.agentDownloadUrl}/download/POSprint-Agent-macOS.dmg`;
      detectedOS = 'macOS';
    } else if (userAgent.includes('linux') || platform.includes('linux')) {
      downloadUrl = `${ENV_CONFIG.agentDownloadUrl}/download/POSprint-Agent-Linux.AppImage`;
      detectedOS = 'Linux';
    }
        ...
        <div className="agent-instructions-modal">
          <div className="instructions-card">
            <div className="instructions-header d-flex">
              ...
              <h2>POSprint Agent Setup</h2>
            </div>
            <p className="instructions-intro">
              To connect to physical printers and cash drawers, you need to install the POSprint Agent on your computer.
            </p>
...
Thank you for your business!`);
      ...
      <footer className="app-footer">
        <div className="footer-content">
          <p>
            <Printer size={16} /> POSprint Print Tester •
